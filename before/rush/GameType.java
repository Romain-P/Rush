...
public class GameType {
	...
	public GameType(String name, String waitMap, String map, List<String> teamNames, List<String> teamPrefixes, List<String> teamColours, List<int[]> waitLocs, List<int[]> locs) {
		this.name = name;
